...
\newcounter{eje_counter}
\setcounter{eje_counter}{0}
\newenvironment{ejercicio}
{ % Pre'ambulo
  %\hrule
  \begin{quote}
  %\begin{shabox}
  \refstepcounter{eje_counter}
  \textbf{Ejercicio \arabic{eje_counter}:}
  %\end{shabox}
}
{ % Finalizaci'on
  \end{quote}
...
%\getenv[\WWWROOT]{WWWROOT}

%}}}

\newcounter{taller_counter}
\setcounter{taller_counter}{0}
\newenvironment{taller}
{ % Preámbulo
  %\hrule
  \begin{quote}
  %\begin{shabox}
  \refstepcounter{taller_counter}
  \textbf{Taller \arabic{taller_counter}:}
  %\end{shabox}
}
{ % Finalización
  \end{quote}
